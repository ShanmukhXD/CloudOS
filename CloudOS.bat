...
echo Source code available at: https://github.com/ShanmukhXD
...
echo Feature update to CloudOS 21H2 
echo CloudOS Security update (2089328472934)
echo Driver update for ClousOS touchpad precision (219090)
...
echo Details
echo Time: %time% Date: %date% Source: Desktop Path: C:\OS\sysos\32 Name: os64hack:tool/enough
echo Hits:21
